...
export const SingleHeroSection = () => {
  return (
    <div className="bg-no-repeat mt-[48px] lg:px-[50px] px-[4%] xl:px-[112px] w-full h-[calc(100vh-182px)] flex  relative">
      <div className="flex flex-col  w-full px-[4%] lg:px-[80x] xl:px-[109px]">
        ...
        <div className="flex items-center justify-center h-[calc(100vh-182px)]">
          <div className="gap-8 flex py-8 items-center">
            <div className="bg-Brand/Primary/Primary-100 xl:min-w-[384px] rounded-lg h-[385px] pb-0 ">
              <Image
            ...
            <div className="flex flex-col gap-4">
              <h2 className="font-DarkerGrotesque text-[42px] 2xl:text-[60px] font-bold text-[#222] leading-[50px] lg:max-w-[544px]">
