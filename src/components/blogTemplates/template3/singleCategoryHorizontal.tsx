...
export const SingleCategoryHorizontal = () => {
  return (
    <div className="flex items-start  gap-8 w-full h-[140px]">
      <div className="bg-Brand/Primary/Primary-100 min-w-[176px]  rounded-lg h-full pb-0">
        <Image
      ...
      <div className="flex flex-col gap-[8px] h-full justify-between">
        <p className="font-DarkerGrotesque text-[34px] font-bold  leading-[42px] text-[#222] line-clamp-1">
          Your most unhappy customers are your greatest source of learning.
        </p>
        <p className="font-DarkerGrotesque text-[18px] font-medium  leading-[110%] text-Brand/Text/Text-800 line-clamp-2">
