...
const AIHub = () => {
  ...
  return (
    <section className="pt-8 pb-8 px-4 sm:px-6 min-h-screen bg-Brand/Surface/surface-200 2xl:px-[4%] absolute  w-full md:w-[75%] lg:w-[80%]  xl:w-[85%] right-0">
      ...
      <div className="w-full flex flex-col  mt-4 bg-Brand/Surface/surface-50 rounded-lg">
        <div className="w-full flex justify-between items-center border-b border-b-Gray/200">
          <h3 className=" px-6 py-3 text-[14px] leading-normal font-DarkerGrotesque font-medium text-Brand/Text/Text-600 w-full lg:w-[35%]">
            AI Model
          </h3>
          <h3 className="hidden lg:block px-6 py-3 text-[14px] leading-normal font-DarkerGrotesque font-medium text-Brand/Text/Text-600 w-[35%]">
            Output
          </h3>
          <h3 className="hidden lg:block px-6 py-3 text-[14px] leading-normal font-DarkerGrotesque font-medium text-Brand/Text/Text-600 w-[15%]">
            Date Created
          </h3>
          <h3 className="hidden lg:block px-6 py-3 text-[14px] leading-normal font-DarkerGrotesque font-medium text-Brand/Text/Text-600 w-[15%]">
            Actions
        ...
        {aiModel.map((elem, index) => {
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3 w-full lg:w-[35%] px-6 py-4">
                {" "}
              ...
              <div className="hidden lg:flex justify-center items-center px-6 py-4 text-[16px] leading-normal  font-DarkerGrotesque text-gray/500 max-w-[35%] w-[35%]">
                <h3 className="line-clamp-1 text-ellipsis overflow-hidden font-medium ">
                  {output}
                </h3>
              </div>

              <h3 className=" hidden lg:block px-6 py-4 text-[16px] leading-normal font-DarkerGrotesque text-Gray/500 font-medium  w-[15%]">
                {date}
              </h3>
              <div className="hidden lg:block  px-6 py-4 text-[14px] leading-normal font-DarkerGrotesque font-medium text-Brand/Text/Text-600 w-[15%]">
                <TrashIcon />
              </div>
            </div>
          );
