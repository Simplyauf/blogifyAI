        ...
        <section className="mt-4 w-full bg-Brand/Surface/surface-50 rounded-lg p-6 flex flex-col gap-6">
          ...
          <div className="w-full flex items-start gap-6">
            <div className="w-[25%] flex flex-col gap-4">
              ...
              <button className="flex  border-[1.5px] items-center justify-center  w-[115px] h-[32px] min-w-fit text-Brand/Text/Text-800 border-Brand/Text/Text-400 rounded-[8px] px-4 py-2 gap-[8px] text-[14px] font-medium  leading-4 font-DarkerGrotesque">
            ...
            <div className="grid grid-cols-2  gap-x-6 gap-y-4 w-[75%]">
              <div className="flex flex-col">
                <h4 className="text-[16px] leading-normal font-DarkerGrotesque font-semibold text-Brand/Text/Text-400">
                  Name
                </h4>
        ...
        <section className="mt-6 w-full bg-Brand/Surface/surface-50 rounded-lg p-6 flex flex-col gap-6">
          ...
          <div className="mt-2 w-full">
            <div className="w-full flex items-center gap-4 px-4 py-2 border-b border-b-Surface/surface-400">
              ...
              <div className="w-full items-center gap-[8px] h-12 grid grid-cols-5">
            ...
            <div className="h-[130px] overflow-y-auto w-full custom-overflow">
              ...
              >
                ...
                <div className="w-full items-center gap-[8px] h-12 grid grid-cols-5">
                  ...
                  <h2 className="px-2 font-DarkerGrotesque text-[18px] font-normal leading-[26px] text-Brand/Text/Text-800 underline">
                    View details
                  </h2>
                </div>
              </div>
